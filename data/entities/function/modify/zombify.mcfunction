...
execute as @s[scores={entity.random=40..89}] at @s if biome ~ ~ ~ minecraft:desert run return summon husk ~ ~ ~ {CanPickUpLoot:1b,CanBreakDoors:1b,Tags:["mob"]}
execute as @s[scores={entity.random=0..89}] at @s run summon zombie ~ ~ ~ {CanPickUpLoot:1b,CanBreakDoors:1b,Tags:["mob","zombie"]}

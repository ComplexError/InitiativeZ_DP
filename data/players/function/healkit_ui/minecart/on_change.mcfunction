...
execute if data storage ui in[0] run return run function players:healkit_ui/menu/on_input
...
execute if data storage ui in[0] unless data storage ui in[1] run return run function players:healkit_ui/menu/on_click

# Update Page & History if nothing happened
function players:healkit_ui/menu/refresh
...
# unique ui.id assignment (minecart & player)
...
execute as @e[type=chest_minecart,tag=new] run function players:healkit_ui/menu/demo/root/open
execute as @e[type=chest_minecart,tag=new] run function players:healkit_ui/minecart/load_page

...
execute at @s[tag=bandaging] as @n[scores={Player_BandageCD=0,Master_Looktarget=1..},tag=!bandaging] run function players:mechanics/bandaging/add_ointment

clear @s[tag=bandaging] red_dye[minecraft:max_stack_size=2] 1

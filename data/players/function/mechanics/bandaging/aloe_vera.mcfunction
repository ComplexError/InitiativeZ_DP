...
execute as @a[tag=!bandaging,scores={Player_BandageCD=0},predicate=master:is_sneaking] at @s if entity @p[distance=..4,tag=bandaging] run function players:mechanics/bandaging/add_aloe

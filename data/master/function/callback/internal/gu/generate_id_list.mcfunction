...
function master:callback/internal/gu/get_hexes with storage gu:temp
function master:callback/internal/gu/concat_uuid with storage gu:temp

data modify storage callback entities append from storage gu:main out
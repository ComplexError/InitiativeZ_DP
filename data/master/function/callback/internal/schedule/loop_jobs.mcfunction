...
execute if score .entities callback matches 1.. at 00000063-0000-0077-0000-006300000062 run function master:callback/internal/schedule/loop_entities

data remove storage callback jobs[0]
scoreboard players remove .jobs callback 1
execute if score .jobs callback matches 1.. run function master:callback/internal/schedule/loop_jobs
schedule function ambient_hazards:timer4 1s
function ambient_hazards:effects/ailments1
function ambient_hazards:effects/illness2
...
## -- Burning Players --
execute as @a if predicate ambient_hazards:on_fire run scoreboard players add @s AmbientH_Scale 30
execute as @a if predicate ambient_hazards:on_fire run scoreboard players add @s AmbientH_Scale 30
...
execute as @a[gamemode=!survival] run scoreboard players set @s AmbientH_Scale 0
execute as @a[gamemode=!survival] run scoreboard players set @s AmbientH_Dialogue 0
execute as @a[gamemode=!survival] run scoreboard players set @s AmbientH_Wetness 0

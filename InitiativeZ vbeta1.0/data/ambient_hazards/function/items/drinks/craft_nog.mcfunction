summon item ~ ~ ~ {Glowing:1b,Item:{id:"minecraft:potion",count:1,components:{"minecraft:custom_name":'{"bold":true,"color":"#FFE59E","italic":true,"text":"Nog"}',"minecraft:lore":['{"color":"white","text":"The Rich and Creamy beverage can prevent the cold from being a hinderance."}'],"minecraft:custom_data":{itemNog:true},"minecraft:potion_contents":{potion:"minecraft:thick",custom_color:16766323}}}}
